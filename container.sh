...
#                                                                             #
# Manage containers for the Responsive Website Development and Design         #
# Specialization                                                              #
...
function display_banner() {
	...
	echo
	echo "Website Development Toolbox for 'Responsive Website Development and Design Specialization'"
	echo "version 0.1, Copyright (C) 2015 Gregory D. Horne"
	echo
	echo "Website Development Toolbox comes with ABSOLUTELY NO WARRANTY;"
	echo "for details read the LICENSE file."
	echo "This is free software, and you are welcome to redistribute it"
	echo "under certain conditions; read the LICENSE for details."
	echo
	echo "Further informmation about the Responsive Website Development and"
	echo "Design Specialization offered by Johns Hopkins University as a"
	echo "Massively Open-Online Course (MOOC) using the Coursera platform can"
	echo "be found at"
	echo -e "\n\tResponsive Website Development and Design Specialization"
	echo -e "\t\thttps://www.coursera.org/specializations/website-development"
	echo -e "\n\tCoursera\n\t\thttps://coursera.org"
	echo
	echo "This software and associated documentation has been developed"
	echo "independently of University of London and Coursera. It is"
	echo "provided as a convenience to participants in the Responsive Website"
	echo "Development and Design Specalization."
	echo
	echo
}
...
function display_version() {
	...
	echo
	echo "Website Development Toolbox for 'Responsive Website Development and"
	echo "Design Specialization'"
	echo "version 0.1, Copyright (C) 2015 Gregory D. Horne"
	echo
}
